...
<head>
    ...
    <script src="__PUBLIC__/Admin/js/base_login.js" type="text/javascript" charset="utf-8"></script>
	<title>后台登陆</title>
</head>
<body>
	<div id="login_top">
	...
	<div id="login_center">
		<div id="login_area">
			<div id="login_form">
				<form action="{:U('Login/checkInfo')}" id="form_login" method="post">
					<div id="login_tip">
						用户登录&nbsp;&nbsp;UserLogin
					</div>
					...
					<div id="btn_area">
						<input type="button" id="sub_btn" onclick="ajaxLogin('{:U('Login/login')}')" value="登&nbsp;&nbsp;录">&nbsp;&nbsp;
						<input type="text" name="verify" class="verify">
						<img id="verifyImg" src="{:U('Login/verifyImg')}" alt="" width="100" height="40">
					</div>
				</form>
			</div>
		</div>
