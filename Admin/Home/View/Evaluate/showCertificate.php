	...
	<table border="1px" cellspacing="0" width="100%" id="table" >
		...
		<foreach name="allCertificate" item="vo">
			<tr>
				...
				<td align="center">
					<img src="__ROOT__{$vo['route']}" width="400px" height="200px"/>
				</td>
				<td align="center">
				...
				<td align="center">
					<a href="javascript:void(0)" onclick="ajaxFixScore('{:U('Evaluate/runEvaluateCer')}',{$vo['id' ]})">[确认此评分]</a>
					<a href="javascript:void(0)" onclick="ajaxDisAgree('{:U('Examine/verifyCertificate')}',{$vo['id']})"><font color="red">[不通过]</font></a>	
				</td>
			</tr>
		</foreach>
	</table>
