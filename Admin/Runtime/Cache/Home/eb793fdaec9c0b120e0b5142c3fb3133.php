...
<html lang="zh-CN">
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<tr>
			<th>标题：<?php echo (htmlspecialchars($root['title'] )); ?><br />详细内容：<?php echo ($root['content']); ?></th>
			<th><?php echo ($root['uid']); ?></th>
			<th><?php echo ($root['date']); ?></th>
			<th><a href="<?php echo U('Consult/delData',array('id'=>$root['id']));?>">[删除]</a></th>
		</tr>
		<?php if(is_array($floor)): foreach($floor as $key=>$vo): ?><tr>
				<td align="left"><?php echo (htmlspecialchars($vo['content'] )); ?></td>
