...
<html lang="zh-CN">
	...
	<link rel="stylesheet" type="text/css" href="/Project/Public/Admin/css/Examine_certificate.css"/>
	...
	<table width="100%" border="1px" cellspacing="0" >
		...
		<?php if(is_array($certificate_list)): foreach($certificate_list as $key=>$vo): ?><tr>
			    	...
			    	<td align="center">
			    		<a href="javascript:void(0)" onclick="ajaxAgree('<?php echo U('Examine/verifyCertificate');?>',<?php echo ($vo['id']); ?>)"><font color="blue">[重新通过]</font></a>
			    	</td>
