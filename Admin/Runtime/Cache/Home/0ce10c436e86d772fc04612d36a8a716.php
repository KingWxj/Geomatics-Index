...
<html lang="zh-CN">
	...
	<table border="1px" cellspacing="0" width="100%" id="table" >
		...
		<?php if(is_array($allCertificate)): foreach($allCertificate as $key=>$vo): ?><tr>
				...
				<td align="center"><img src="/Project<?php echo ($vo['route']); ?>" width="400px" height="200px"/></td>
				...
				<td align="center">
					<a href="javascript:void(0)" onclick="ajaxFixScore('<?php echo U('Evaluate/runEvaluateCha');?>',<?php echo ($vo['id' ]); ?>)">[确认此评分]</a>
					<a href="javascript:void(0)" onclick="ajaxDisAgree('<?php echo U('Examine/verifyCharacter');?>',<?php echo ($vo['id']); ?>)"><font color="red">[不通过]</font></a>	
				</td>
