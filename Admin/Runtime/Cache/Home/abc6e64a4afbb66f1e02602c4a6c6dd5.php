...
<html lang="zh-CN">
	...
	<script src="/Public/Admin/js/Examine_score.js" type="text/javascript" charset="utf-8"></script>
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<?php if(is_array($fixList)): foreach($fixList as $key=>$vo): ?><tr>
		    	<td align="center"><?php echo ($vo['stuid']); ?></td>
		    	<td align="center"><?php echo ($vo['name']); ?></td>
		    	<td align="center"><?php echo ($vo['subject']); ?></td>
		    	<td align="center"><?php echo ($vo['score']); ?></td>
		    	<td align="center"><?php echo ($vo['fixscore']); ?></td>
		    	<td align="center">
		    		<a href="javascript:void(0)" onclick="ajaxFixTrue('<?php echo U('Examine/fixScore');?>',<?php echo ($vo['id']); ?>)"><font color="green">[通过]</font></a>&emsp;
		    		<a href="javascript:void(0)" onclick="ajaxFixFalse('<?php echo U('Examine/fixScore');?>',<?php echo ($vo['id']); ?>)"><font color="red">[不通过]</font></a>
		    	</td>
