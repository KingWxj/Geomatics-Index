...
<html lang="zh-CN">
	...
	<link href="/Project/Public/umeditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
	...
	<!--发布公告的表单，写入数据库-->
	<form action="<?php echo U('Excellent/runAddExcellent');?>" method="post" style="margin: 10px 0 0 20px;" enctype="multipart/form-data">
