...
<html lang="zh-CN">
	...
	主页内容管理
		...
		<form action="<?php echo U('Content/index');?>" method="post" style="padding: 10px;">
			<span>您需要管理</span>
			<select name="type">
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<?php else: ?>
			<?php if(is_array($content)): foreach($content as $key=>$vo): ?><tr>
				...
				<td align="center">
					<a href="<?php echo U('Content/updateContent',array('id'=>$vo['id']));?>">[修改]</a>
					<a href="<?php echo U('Content/delContent',array('id'=>$vo['id']));?>">[删除]</a>
				</td>
