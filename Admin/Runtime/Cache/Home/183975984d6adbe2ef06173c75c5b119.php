...
<form action="<?php echo U('Excellent/runUpdateExcellent');?>" method="post" style="margin: 10px 0 0 20px;">
		...
		<input type="text" name="info" id="info" value="<?php echo ($info['info']); ?>"  style="width: 300px; padding: 5px; margin: 5px;"/><br />
