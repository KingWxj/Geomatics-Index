...
<html lang="zh-CN">
	...
	<style>
		...
		#title {width: 15%;}
		#picture {width: 30%;}
		#content {width: 40%;text-indent: 2em;text-align: left;}
	</style>
		...
		<div class="side" style="overflow: scroll;overflow-x: hidden;">
			<div class="sideMenu" style="margin:0 auto;">
				...
				<ul>
					...
					<li>
						<a href="<?php echo U('Imgtoggle/manager');?>">
							管理轮播图片
						</a>
					</li>
					<li id="down_area">
					...
					<li id="upload_file">
						<a href="<?php echo U('Upload/upload');?>">
							上传文件
						</a>
					</li>
					<li id="consult">
	...
	<table width="100%" border="1" cellspacing="0">
		...
		<?php if(is_array($data)): foreach($data as $key=>$arr): ?><tr>
				...
				<td id="picture" align="center"><img src="<?php echo ($arr['route']); ?>" width="360px" /></td>
				<td id="content"><?php echo ($arr['content']); ?></td><!--|mb_substr = 0,250,'UTF-8'-->
				<td><a href="javascript:void(0)">[上移]</a>
