...
<html lang="zh-CN">
	...
	<form action="<?php echo U('Evaluate/update');?>" method="post" style="margin: 10px 0 0 20px;">
		<input type="hidden" name="id" id="id" value="<?php echo ($info['id']); ?>" />
		<p id="main_title"><label for="title">主标题：</label>
			<input type="text" name="title" id="title" value="<?php echo ($info['title']); ?>" /><br /></p>
		...
		<input type="text" name="info" id="info" style="height: 20px;border: 2px solid skyblue;" value="<?php echo ($info['info']); ?>" />
		<label for="date">日期：<input type="text" style="height: 20px;border: 2px solid skyblue;" name="date" id="date" value="<?php echo ($info['date']); ?>" />(格式:2016-09-10)</label><br />
		</p>
		
		<div id="editor" style="margin-left: 30px; margin-top: 20px;">
			<script id="content" name="content" type="text/plain" style="width: 98%;"><?php echo ($info['content']); ?></script>
			<!-- 配置文件 -->
