...
<html lang="zh-CN">
	...
	<script src="/Project/Public/Admin/js/Upload_index.js" type="text/javascript" charset="utf-8"></script>
	...
	<form action="<?php echo U('Upload/runUpload');?>" method="post" enctype="multipart/form-data">
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<?php if(is_array($fileList)): foreach($fileList as $key=>$list): ?><tr>
				<td><?php echo ($list['id']); ?></td>
				<td><?php echo ($list['title']); ?></td>
				<td><?php echo ($list['name']); ?></td>
				<td><?php echo ($list['size']); ?> kb</td>
				<td><?php echo ($list['date']); ?></td>
				<td>
					<a href="javascript:void(0)" onclick="ajaxDelFile('<?php echo U('Upload/delFile');?>','<?php echo ($list['id']); ?>')">
						[删除]
					</a></td>
