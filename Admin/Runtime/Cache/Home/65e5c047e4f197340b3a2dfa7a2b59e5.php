...
<html lang="zh-CN">
	...
	<?php echo ($root); ?>列表项管理
	<span style="margin: 0 0 0 30px;"><a href="<?php echo U('Nav/addListView',array('root'=>$root,'rootid'=>$rootid));?>"><button style="padding: 3px 5px; background: lightskyblue; border: none;">添加列表项的内容</button></a></span>
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<td align="center">
					<a href="<?php echo U('Nav/updateListView',array('rootid'=>$rootid,'id'=>$vo['id']));?>">[修改]</a>
					&emsp;<a href="<?php echo U('Nav/delListItem',array('id'=>$vo['id']));?>">[删除]</a>
				</td>
			</tr><?php endforeach; endif; ?>
		<tr><td colspan="4" align="center">
			<?php echo ($page); ?>
			<?php if($page == null): ?>没有数据！<?php endif; ?>
		</td></tr>
	</table>
