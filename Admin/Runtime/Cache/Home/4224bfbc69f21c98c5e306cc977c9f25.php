...
<html lang="zh-CN">
	...
	<script src="/Public/Admin/js/School_index.js" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
		$().ready(function(){
			$("#school").attr('class','on');
		})
	</script>
	...
	<table border="1px" cellspacing="0" width="100%">
		...
		<?php if(is_array($school)): foreach($school as $key=>$school): ?><tr>
				<td><?php echo ($school['adminName']); ?></td>
				<td><?php echo ($school['title']); ?></td>
				<td><?php echo ($school['date']); ?></td>
				<td>
					<a href="<?php echo U('School/updateSchool',array('id'=>$school['id']));?>">
						[修改]
					</a>
					<a href="javascript:void(0)" onclick="ajaxDelSchool('<?php echo U('School/delSchool');?>','<?php echo ($school['id']); ?>')">
						[删除]
					</a></td>
