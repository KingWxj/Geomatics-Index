...
<body>
	...
	<div id="info" style="margin:10px 0;padding: 20px;border: 1px solid black;" oncontextmenu="event.returnValue=false" onselectstart="event.returnValue=false">
		<h1 align="center"><?php echo ($info['title']); ?></h1>
		<p align="center" style="margin: 10px 0;"><small><span><?php echo ($info['info']); ?></span><span style="margin-left: 20px;">发布日期：<?php echo ($info['date']); ?></span></small></p>
		<hr />
