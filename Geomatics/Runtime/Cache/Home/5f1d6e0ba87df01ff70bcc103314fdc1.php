...
<body>
	...
	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><a href="<?php echo ($vo['route']); ?>"><li style="padding: 5px;cursor: pointer;"><span><?php echo (mb_substr($vo['title'] ,0,35,utf8)); ?></span><span style="float: right;"><?php echo (mb_substr($vo['date'] ,0,10,utf8)); ?></span></li></a><?php endforeach; endif; ?>
