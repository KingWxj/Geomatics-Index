...
<meta name="renderer" content="webkit">
	...
	<link rel="stylesheet" type="text/css" href="/Project/Public/Geomatics/css/Personal_certificate.css"/>
...
<body>
	...
	<div id="content">
		...
		<div id="upload_bar">
			<form action="<?php echo U('Personal/uploadCertificate');?>" method="post" enctype="multipart/form-data">
		...
		<div id="show_certificate">
			<?php if(is_array($certificate_list)): foreach($certificate_list as $key=>$vo): ?><div class="certificate_box">
			    	<img src="/Project<?php echo ($vo['route']); ?>" width="200px" height="110px"/>
			    	<p><?php echo ($vo['name']); ?></p>
			    	<p class="verify_info"><?php if($vo['verify'] == 0): ?><font color="blue">待审核</font>
