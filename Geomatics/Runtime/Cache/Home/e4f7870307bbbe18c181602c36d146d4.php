...
<body>
	...
	<?php if(is_array($allTheme)): foreach($allTheme as $key=>$vo): ?><li style="overflow: hidden;">
			<a href="<?php echo U('Consult/showTheme',array('id'=>$vo['id']));?>"><?php echo (htmlspecialchars($vo['title'] )); ?></a>
			<span style="float: right;"><small><?php echo ($vo['date']); ?></small></span>
