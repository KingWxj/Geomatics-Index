...
<body>
	...
	<div id="mainbody">
		<p style="margin-top: 5px; font-size: 14px;color: #666;">当前位置：优秀事迹列表</p>
		<div id="context">
		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="listbody">
        		...
        		<!--主要内容-->
        		<a href="<?php echo U('Show/excellent',array('id'=>$vo['id']));?>" target="_blank" class="twpic"><img src="/Project<?php echo ($vo['picroute']); ?>" width="150" height="100" alt="<?php echo ($vo['title']); ?>" /></a>		
		...
		<div id="rightlist"><!--右边连接栏-->
			...
			<li id="more"><a href="<?php echo U('List/excellentStudent');?>">更多»</a></li>
		</div>
	</div>
