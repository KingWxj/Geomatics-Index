...
<meta name="renderer" content="webkit">
	...
	<link rel="stylesheet" href="/Public/Geomatics/css/page.css" />
...
<body>
	...
	<li><a href="<?php echo U('List/zxgg');?>">最新公告</a></li>
	<li><a href="<?php echo U('List/xydt');?>">学院动态</a></li>
	<li><a href="<?php echo U('List/xnxw');?>">校内新闻</a></li>
	...
	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><a href="<?php echo U('Show/index',array('id'=>$vo['id']));?>"><li style="padding: 5px;cursor: pointer;"><span><?php echo (mb_substr($vo['title'] ,0,35,utf8)); ?></span><span style="float: right;"><?php echo (mb_substr($vo['date'] ,0,10,utf8)); ?></span></li></a><?php endforeach; endif; ?>
		<div id="page_tab"><?php echo ($page); ?></div>
