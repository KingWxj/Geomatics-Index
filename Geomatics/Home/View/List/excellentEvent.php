	...
	<div id="mainbody">
		...
		<foreach name="list" item="vo">
			<div class="listbody">
        		...
        		<!--主要内容-->
        		<a href="{:U('Show/excellent',array('id'=>$vo['id']))}" target="_blank" class="twpic"><img src="__ROOT__{$vo['picroute']}" width="150" height="100" alt="{$vo['title']}" /></a>		
		...
		<div id="rightlist"><!--右边连接栏-->
			...
			<li id="more"><a href="{:U('List/excellentStudent')}">更多»</a></li>
		</div>
	</div>
</block>
