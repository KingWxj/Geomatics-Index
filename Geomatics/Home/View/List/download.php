...
<block name="right_main_li">
	<foreach name="list" item="vo">
		<a href="__ROOT__{$vo['route']}"><li style="padding: 5px;cursor: pointer;"><span>{$vo['title'] | mb_substr=0,35,utf8}</span><span style="float: right;">{$vo['date'] | mb_substr=0,10,utf8}</span></li></a>
	</foreach>
